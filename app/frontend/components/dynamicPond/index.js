import { Button, Container, SvgIcon, Tooltip, Typography } from '@mui/material';
import { useRouter } from 'next/navigation';
import { useEffect, useState } from 'react';

const DynamicPond = ({ handleClickPond, pond }) => {
    const router = useRouter();
    const [selectedKolam, setSelectedKolam] = useState(pond)
    const [tooltip, setTooltip] = useState({ content: 'Hover over a pond', x: 0, y: 0, offsetY: 0 });

    const onClick = (pondId) => {
        setSelectedKolam(pondId);
        handleClickPond(pondId);
    };
    ...
    return (
        <Container maxWidth="xl" sx={{ p: 0, position: 'relative' }}>
            <svg viewBox="0 0 1000 1800" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
                ...
                {selectedKolam == 1 ? <g x="350" y="300" >
                    {/* <!-- Rectangle --> */}
                    <rect x="385" y="415" height="60" width="230" fill="red" stroke="#ffffff" />

                    {/* <!-- Text inside the rectangle --> */}
                    <text x="500" y="445" font-family="Arial" font-size="20" fill="white" text-anchor="middle" dominant-baseline="middle">
                        Anda Berada Di Sini
                    </text>

                    {/* <!-- Arrow below the rectangle --> */}
                    <polygon points="500,485 490,475 510,475" fill="red" />

                    {/* <!-- Animate both the rectangle, text, and arrow together using <animateMotion> --> */}
                    <animateMotion
                        path="M 0 10 V -10 V 10"
                        dur="3s"
                        repeatCount="indefinite" />
                </g> : <></>}
                {selectedKolam != 1 ? <g x="350" y="300" onClick={() => onClick(1)}>
                    {/* <!-- Rectangle --> */}
                    <rect x="370" y="415" height="60" width="260" fill="rgb(67, 160, 71)" stroke="#ffffff" />

                    {/* <!-- Text inside the rectangle --> */}
                    <text x="500" y="445" font-family="Arial" font-size="20" fill="white" text-anchor="middle" dominant-baseline="middle">
                        Klik sini untuk tukar kolam
                    </text>

                    {/* <!-- Arrow below the rectangle --> */}
                    <polygon points="500,485 490,475 510,475" fill="rgb(67, 160, 71)" />
                ...
                {selectedKolam == 2 ? <g x="350" y="300" >
                    {/* <!-- Rectangle --> */}
                    <rect x="175" y="1100" height="60" width="230" fill="red" stroke="#ffffff" />

                    {/* <!-- Text inside the rectangle --> */}
                    <text x="285" y="1130" font-family="Arial" font-size="20" fill="white" text-anchor="middle" dominant-baseline="middle">
                        Anda Berada Di Sini
                    </text>

                    {/* <!-- Arrow below the rectangle --> */}
                    <polygon points="285,1170 275,1160 295,1160" fill="red" />
                ...
                {selectedKolam != 2 ? <g x="350" y="300" onClick={() => onClick(2)}>
                    {/* <!-- Rectangle --> */}
                    <rect x="159" y="1100" height="60" width="260" fill="rgb(67, 160, 71)" stroke="#ffffff" />

                    {/* <!-- Text inside the rectangle --> */}
                    <text x="288" y="1130" font-family="Arial" font-size="20" fill="white" text-anchor="middle" dominant-baseline="middle">
                        Klik sini untuk tukar kolam
                    </text>

                    {/* <!-- Arrow below the rectangle --> */}
                    <polygon points="285,1170 275,1160 295,1160" fill="rgb(67, 160, 71)" />
                ...
                {selectedKolam == 3 ? <g x="350" y="300" >
                    {/* <!-- Rectangle --> */}
                    <rect x="615" y="1100" height="60" width="230" fill="red" stroke="#ffffff" />

                    {/* <!-- Text inside the rectangle --> */}
                    <text x="730" y="1130" font-family="Arial" font-size="20" fill="white" text-anchor="middle" dominant-baseline="middle">
                        Anda Berada Di Sini
                    </text>

                    {/* <!-- Arrow below the rectangle --> */}
                    <polygon points="730,1170 720,1160 740,1160" fill="red" />
                ...
                {selectedKolam != 3 ? <g x="350" y="300" onClick={() => onClick(3)}>
                    {/* <!-- Rectangle --> */}
                    <rect x="600" y="1100" height="60" width="260" fill="rgb(67, 160, 71)" stroke="#ffffff" />
                    ...
                    {/* <!-- Arrow below the rectangle --> */}
                    <polygon points="730,1170 720,1160 740,1160" fill="rgb(67, 160, 71)" />
