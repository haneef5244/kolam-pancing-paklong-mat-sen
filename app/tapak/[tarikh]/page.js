...
const TapakTarikh = props => {
    ...
    const navigateToPond = (pondId) => {
        router.push(`/tapak/${moment(tarikh).format('YYYY-MM-DD')}/${pondId}`);
    };
    ...
    return (
        <Container maxWidth="md" sx={{ pb: 0, pt: 2 }}>
            <Box mt={2}>
                <Typography fontWeight={'bold'} sx={{ pb: 2, pt: 2 }}>Layout Kolam Pancing Paklong Mat Sen</Typography>
                <svg viewBox="0 0 1000 1800" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text x="500" y="525" font-family="Arial" font-size="30" fill="#000" text-anchor="middle">Kolam 1</text>
                    ...
                    <text x="290" y="1225" font-family="Arial" font-size="30" fill="#000" text-anchor="middle">Kolam 2</text>
                    ...
                    <text x="730" y="1225" font-family="Arial" font-size="30" fill="#000" text-anchor="middle">Kolam 3</text>
